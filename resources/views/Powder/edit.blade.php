...
<html lang="en">
  ...
  <body class="container"><br><br>
    <form method="POST" action="{{ route('powder.update', $powder->id) }}">
    @csrf
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <select class="form-select" name="id_grade" id="id_grade">
                    ...
                    <option value="{{ $value->id }}" {{ $value->id == $powder->id_grade ? 'selected' : '' }}>{{ $value->type }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="row">
                <div class="col-lg-6">
                    ...
                    <select class="form-select" name="id_supplier" id="id_supplier">
                        ...
                        <option value="{{ $value->id }}" {{ $value->id == $powder->id_supplier ? 'selected' : '' }}>{{ $value->vendor }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-6">
